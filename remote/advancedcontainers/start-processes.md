...
```json
"postStartCommand": "nohup bash -c 'your-command-here &///Video: Run 'npm start' whenever the container is started
...
https://secure.serve.com/accounts/4aaa0d939ac74b02853dd65ea51bc769/transactions